-- Day 6/7: persistent chat history for NextAuth users.
...
-- Access is mediated by NextAuth API routes using the Supabase service role.
-- No anon/authenticated policies are added here because NextAuth sessions do not
-- map to Supabase auth.uid() in this project.
