-- Optional migration for NVIDIA NIM nv-embedqa-e5-v5 embeddings.
-- The default NVIDIA embedding model returns 1024 dimensions.
-- Existing 768-dimensional Ollama chunks cannot be reused; re-ingest documents
