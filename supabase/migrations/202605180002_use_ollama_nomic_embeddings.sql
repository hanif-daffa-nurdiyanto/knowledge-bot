-- Switch embedding storage from OpenAI text-embedding-3-small (1536 dims)
-- to Ollama nomic-embed-text (768 dims).
--
-- Existing chunk embeddings cannot be resized safely, so chunks are deleted
-- and documents must be re-ingested after this migration.
